...
namespace ThriftSharp.Internals
{
    ...
    internal sealed class ThriftField
    {
        ...
        /// </summary>
        public ThriftField(short id, string name, bool isRequired, object defaultValue, PropertyInfo backingProperty)
        {
            Id = id;
            Name = name;
    ...
    internal sealed class ThriftParameter
    {
        ...
        /// </summary>
        public ThriftParameter(short id, string name, TypeInfo typeInfo)
        {
            Id = id;
            Name = name;
            UnderlyingTypeInfo = typeInfo;
    ...
    internal sealed class ThriftReturnValue
    {
        ...
        /// </summary>
        public ThriftReturnValue(TypeInfo typeInfo)
        {
            UnderlyingTypeInfo = typeInfo;
        }
    }
