...
{
    public class HttpThriftMessage : IThriftMessage
    {
        public HttpThriftMessage(ThriftTransportType transportType)
        {
        ...
        public HttpThriftMessage CreateMessage()
        {
            return new HttpThriftMessage(this.TransportType);
        }
